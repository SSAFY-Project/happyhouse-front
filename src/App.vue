    ...
    <v-navigation-drawer v-model="drawer" app>
      ...
      <v-list-item align-center>
        <v-list-item-content>
          ...
          <v-list-item-subtitle v-if="this.$store.state.userInfo !== null"> {{this.$store.state.userInfo.userEmail}} </v-list-item-subtitle>

        </v-list-item-content>
      </v-list-item>
      <v-list dense nav>
        <v-list-item router-link to="/manager" v-if="this.$store.state.userInfo !== null && this.$store.state.userInfo.userRole ==='ROLE_ADMIN'">
          <v-list-item-icon>
